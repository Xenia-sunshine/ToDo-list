<style>
    ...
    .dropdown:hover .dropdown-content {
        display: block; /* Показывает контент при наведении */
    }
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-end">
                ...
                <a href="" class="me-3 link-dark text-decoration-none">Поддержка</a>
                <a href="" class="me-3 link-dark text-decoration-none">Цены</a>
                <a href="" class="btn btn-danger me-2">Акции</a>
            </div>
        </div>
    </div>
</header>
